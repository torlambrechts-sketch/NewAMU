...
| 18 | **C3 (full)** · RPC-er for valg/tall (serverside gate); i **Analyse** og CSV brukes de kun når undersøkelsen er **anonym** (`is_anonymous`) og terskel er nådd. **Identifiserte** undersøkelser viser aggregater uten k-anonymitetskrav (fritekst fortsatt ikke ordrett i analysen) | `20260828120016_survey_analytics_rpc_extend.sql`, `surveyAnalyticsRpc.ts`, `SurveyAnalyseTab.tsx`, `surveyExportCsv.ts` |
