// Settings-hub wrapper for the Survey "Arbeidsflyt" tab. The previous
  ...
  return (
    <ModuleSectionCard className="p-5 md:p-6">
      <div className="mb-3 flex items-center gap-2">
        ...
        <h2 className="text-lg font-semibold text-neutral-900">Arbeidsflyt for undersøkelser</h2>
      </div>
      ...
      <Link to="/workflow?source_module=survey">
        <Button variant="primary">Åpne arbeidsflyt for undersøkelser</Button>
      </Link>
    </ModuleSectionCard>
  )
}
