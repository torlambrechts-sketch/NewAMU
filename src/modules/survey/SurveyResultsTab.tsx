...
import type { SurveyCampaignRow, SurveyPillar, SurveyResultRow } from '../../data/survey'
import { PILLAR_LABEL, PILLAR_COLOR, scoreColor, scoreBg, scoreLabel } from '../../data/survey'
