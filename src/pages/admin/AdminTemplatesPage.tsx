...
// All shared configuration (source maps, status pill, drawer state,
// page-size options) lives in `adminTemplatesConstants.ts` so other
// components on this surface can import without pulling in the whole
// page module.
import {
  SOURCE_KEYS,
  STATUS_KEYS,
        ...
        <div className="flex flex-wrap items-center gap-3 border-b border-neutral-100 px-4 py-3 sm:px-5">
          <div className="relative min-w-[220px] flex-1">
            ...
            <StandardInput
              ...
              className="rounded-lg py-2 pl-10 pr-9 focus:ring-2 focus:ring-[#1a3d32]/25"
            />
            {search ? (
              <Button
                variant="ghost"
                ...
                aria-label="Tøm søk"
                className="absolute right-2 top-1/2 h-auto w-auto -translate-y-1/2 rounded-full p-1 text-neutral-400 hover:bg-neutral-100 hover:text-neutral-700"
              >
