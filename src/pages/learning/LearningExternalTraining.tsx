        ...
        <div className="rounded-lg border border-[#e3ddcc] bg-[#fbf9f3]">
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-2">
                    ...
                    {canManage && x.status === 'pending' ? (
                      <div className="flex flex-col gap-1">
                        ...
                        {approveError ? <p className="mt-2 text-xs text-red-700">{approveError}</p> : null}
                      </div>
                    ) : null}
                  </div>
                </li>
          ...
          {externalCertificates.length === 0 ? (
            <div className="flex flex-col items-center gap-3 rounded-xl border border-dashed border-neutral-200 bg-[#fbf9f3] py-12 text-center">
              ...
              <p className="text-sm text-neutral-500">Ingen innsendte dokumenter ennå.</p>
              {canManage ? (
                <p className="text-xs text-neutral-400">Ansatte kan sende inn dokumentasjon fra denne siden.</p>
              ) : null}
            </div>
          ) : null}
        </div>
