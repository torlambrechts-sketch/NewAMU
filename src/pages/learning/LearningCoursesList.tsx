                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex shrink-0 flex-col items-end gap-1 text-[11px]">
                      <AddTaskLink
                        ...
                        sourceId={c.id}
                        sourceLabel={c.title}
                        className="rounded-full border border-neutral-200 px-2 py-0.5 font-medium text-[#1a3d32] hover:bg-neutral-50"
                      >
                        Oppgave
                      </AddTaskLink>
                      {canManage ? (
                        <select
                          ...
                          className="max-w-[7rem] rounded-full border border-neutral-200 bg-white px-1.5 py-0.5 text-[10px]"
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {unlocked ? (
                      <Link
                        ...
                        className="inline-flex flex-1 items-center justify-center rounded-full bg-[#1a3d32] px-3 py-2 text-center text-xs font-medium text-white hover:opacity-95"
                      >
                        Åpne kurs
                      </Link>
                    ) : (
                    ...
                    {canManage ? (
                      <Link
                        to={`/learning/courses/${c.id}`}
                        className="inline-flex items-center justify-center rounded-full border border-neutral-200 px-3 py-2 text-xs font-medium text-[#1a3d32] hover:bg-neutral-50"
                      >
                        Bygger
                      </Link>
                    ) : null}
