/**
 * /table-test — gallery of reference table styles taken directly from shadcn/ui
 * and TanStack Table examples, restyled to match our workplace shell (cream
 * header band, forest accent, Libre Baskerville serif). Tables 3 and 4 are
 * expandable; section 6 is the full <OKRDashboard /> with its own Cards/Matrix
 * tab switcher.
 *
    ...
    <div className="min-h-screen bg-[#F7F4EE] pb-20">
      <PageContainer width="wide" py="py-8">
        <WorkplacePageHeading1
          ...
          description={
            <>
              ...
              Libre Baskerville). Tabellene 3 og 4 er ekspanderbare; seksjon 6
              viser et fullt OKR-dashbord med Kort/Matrise-veksler.
            </>
          }
        />
        ...
        <footer className="mt-12 flex items-center justify-between border-t border-neutral-200 pt-6 text-xs text-neutral-500">
          ...
          <span>5 tabeller + 1 OKR-dashbord · 3 ekspanderbare</span>
        </footer>
      </PageContainer>
    </div>
  )
...
/* ── 6) OKR dashboard — sample objectives ─────────────────────────────────── */

const OKR_OBJECTIVES: Objective[] = [
  {
    id: 'O-1',
