...
import { BarChart3, Download, Loader2, Mail, Plug, Plus, ScrollText, Shield, ShieldAlert, Upload, UserCheck, UserCog, UserSearch, Users } from 'lucide-react'
...
import { RegelverkCoveragePage } from './admin/RegelverkCoveragePage'
...
const ADMIN_TABS = [
  ...
  { id: 'regelverk_coverage', label: 'Regelverk-dekning', icon: ScrollText },
...
export function AdminPage() {
  ...
  return (
    ...
    >
      ...
      {tab === 'regelverk_coverage' && !loading ? (
        <RegelverkCoveragePage />
      ) : null}
