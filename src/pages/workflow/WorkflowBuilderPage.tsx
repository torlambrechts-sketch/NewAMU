...
import { BookOpen, CheckCheck, ClipboardList, PlayCircle, ScrollText, ShieldCheck, Workflow } from 'lucide-react'
...
type Tab = 'library' | 'canvas' | 'runs' | 'dry-run' | 'approvals' | 'evidence' | 'revisions'

const TABS: { id: Tab; label: string; Icon: typeof BookOpen }[] = [
  { id: 'library', label: 'Mal-bibliotek', Icon: BookOpen },
  { id: 'canvas', label: 'Bygg', Icon: Workflow },
