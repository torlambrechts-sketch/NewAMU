...
| 9.4 | 🚧 | Phase 3 — UI string extraction | ~4,000–4,500 strings across ~440 files, module by module. Done: `ShellHeaderWidgets` (`shell.header.*`, incl. first plural) + the locale switcher. Remaining: shell/nav bulk, every feature module, admin, validation messages, ~68 hardcoded `nb-NO` formatting sites → `lib/i18n/format.ts`. |
