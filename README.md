...
- **/documents** — **Dokumentsenter** (fase 1): bibliotek, maler (HMS/ROS/AMU/varsling), versjoner, arbeidsflyt (utkast → godkjenning → publisert), eierskap, revisjonslogg; **/documents/settings** har eksport/import JSON og veikart for fase 2–3.
