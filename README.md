...
- **/documents** — **Dokumentsenter** (fase 1–2): bibliotek, maler med variabler og sjekkliste, wiki-lenker `[[tittel]]`, **/documents/search**, **/documents/compliance** (kravmatrise), flertrinns godkjenning (demo), lesebekreftelse, modullenker, kommentarer; **/documents/settings** eksport/import og veikart fase 3.
