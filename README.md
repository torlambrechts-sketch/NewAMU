...
- **/hse** — HMS / verneombud: **vernerunder** med AML-sjekkliste, **inspeksjoner** (malbaserte runder med dynamiske felt: ja/nei/N/A, tekst, tall, bilde; lokasjon/objekt; statusflyt; avvik med alvorlighetsgrad og frist; tidsplan «kjør forfalte»), **/hse/inspection-settings** (typer, maler, lokasjoner, roller, statuser, planer, avvik — JSON eksport/import; produksjon: se `backend/firebase/hseInspectionsModule.md`), klassisk fritekst-inspeksjonslogg, **hendelser/nestenulykker**, AML-struktur, **revisjonslogg**. Data: `localStorage` `atics-hse-v2`.
