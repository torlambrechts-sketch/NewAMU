-- Repair: DBs that still have an older amu_compliance_status (e.g. column 2
-- organization_id) cannot use CREATE OR REPLACE to swap to "year" — use DROP+CREATE.
-- Also safe if 20260801024000 was edited/run as CREATE OR REPLACE only.
