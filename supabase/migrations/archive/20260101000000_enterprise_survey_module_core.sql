-- Enterprise survey core DDL. Must run before 20260427120000_survey_type_and_external.sql and
-- 20260801100000_survey_additions.sql (previously only present under migrations/archive/).
