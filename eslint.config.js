...
export default defineConfig([
  ...
  // would flood lint output and need their own dedicated PR.
  {
    files: [
      ...
      'src/components/layout/aticsNavBuilder.ts',
      'src/components/layout/recentPaths.ts',
      'src/components/layout/OrgSwitcher.tsx',
      'src/components/layout/RegulationFilterMenu.tsx',
      'src/components/layout/WorkplaceStandardFormPanel.tsx',
      'src/components/layout/WorkplaceStandardListLayout.tsx',
      'src/components/layout/WorkplaceDashboardShell.tsx',
      'src/components/layout/HubMenu1Bar.tsx',
      'src/components/module/ModulePageShell.tsx',
      'src/components/module/ModuleAnalyticsDashboard.tsx',
      'src/components/compliance/ComplianceModuleChrome.tsx',
    ],
