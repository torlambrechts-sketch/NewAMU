...
- Migrations: Add **new** SQL migrations as `supabase/migrations/YYYYMMDDHHMMSS_*.sql`. Older migrations stay in `supabase/migrations/archive/`. Use `scripts/apply-migrations.sh` to apply the full tree in timestamp order.
